 function [tempH,H,InputWeight,OutputWeight,Y]= elm_train1(TrainingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
if Elm_Type == REGRESSION
    [trrmse,trmae,trr2]=perfomance(T,Y);               %   Calculate training accuracy (RMSE) for regression case
    output=Y;    
end
% clear H;
